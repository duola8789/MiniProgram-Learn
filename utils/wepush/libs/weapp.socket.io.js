!function (t, e) {
  ...
  return function (t) {
    ...
    var n = r(0)("socket.io-parser"), o = r(3), i = r(20), s = r(2), a = r(9);
    ...
    u.prototype.encode = function (t, r) {
      (n("encoding packet %j", t), e.BINARY_EVENT === t.type || e.BINARY_ACK === t.type) ? function (t, e) {
        i.removeBlobs(t, function (t) {
          var r = i.deconstructPacket(t), n = f(r.packet), o = r.buffers;
          o.unshift(n), e(o)
        })
      }(t, r) : r([f(t)])
      ...
      if ("string" == typeof t) r = function (t) {
        ...
        if (t.charAt(++r)) {
          ...
          }(t.substr(r)), f = !1 !== c && (o.type === e.ERROR || s(c));
    ...
    var n = r(4), o = r(3), i = r(18), s = r(6), a = r(5), u = r(0)("socket.io-client:socket"), c = r(17), f = r(16);
    t.exports = l;
    var h = {
      connect: 1,
      connect_error: 1,
    ...
    o(l.prototype), l.prototype.subEvents = function () {
      ...
      if (u("transport is open - connecting"), "/" !== this.nsp) if (this.query) {
        ...
        u("sending connect packet with query %s", t), this.packet({ type: n.CONNECT, query: t })
      ...
      return function () {
        if (!r) {
          r = !0;
          var o = i(arguments);
          u("sending ack %j", o), e.packet({ type: f(o) ? n.BINARY_ACK : n.ACK, id: t, data: o })
        }
      }
      ...
      return this.connected && (u("performing disconnect (%s)", this.nsp), this.packet({ type: n.DISCONNECT })), this.destroy(), this.connected && this.onclose("io client disconnect"), this
    ...
    var n = r(19), o = r(7), i = r(3), s = r(4), a = r(6), u = r(5), c = r(0)("socket.io-client:manager"), f = r(11),
      h = r(10), p = Object.prototype.hasOwnProperty;
    ...
    e.read = function (t, e, r, n, o) {
      var i, s, a = 8 * o - n - 1, u = (1 << a) - 1, c = u >> 1, f = -7, h = r ? o - 1 : 0, p = r ? -1 : 1,
        l = t[e + h];
      ...
      var s, a, u, c = 8 * i - o - 1, f = (1 << c) - 1, h = f >> 1,
 ...
 */
      ...
      u.prototype.slice = function (t, e) {
        ...
        if (e >>>= 0, r = void 0 === r ? this.length : r >>> 0, t || (t = 0), "number" == typeof t) for (i = e; i < r; ++i) this[i] = t; else {
          var s = u.isBuffer(t) ? t : j(new u(t, n).toString()), a = s.length;
    ...
    window, t.exports = function (t) {
      ...
      (function (t) {
        ...
        e.encodePacket = function (r, n, o, i) {
          ...
          var a = p[r.type];
          return void 0 !== r.data && (a += o ? u.encode(String(r.data), { strict: !1 }) : String(r.data)), i("" + a)
      ...
      const n = r(10), o = r(9), i = r(2)("weapp-socket:"), s = ["CONNECTING", "OPEN", "CLOSING", "CLOSED"];
      ...
      class a extends n {
        ...
        send(t) {
          i("send data: ", t, this.readyState), this.readyState === a.OPEN && this._socket.send({ data: t })
        }

        close(t, e) {
          i("close socket: ", t, e), this.readyState = a.CLOSING, this._socket.close({ code: t, reason: e })
        }
      }
 ...
 */
      ...
      (function (e) {
        var n = r(20), o = Object.prototype.toString,
          i = "function" == typeof Blob || "undefined" != typeof Blob && "[object BlobConstructor]" === o.call(Blob),
          s = "function" == typeof File || "undefined" != typeof File && "[object FileConstructor]" === o.call(File);
        t.exports = function t(r) {
          if (!r || "object" != typeof r) return !1;
      ...
      (function (e) {
        var n, o = r(5), i = r(1), s = r(3), a = r(13), u = r(12), c = r(2)("engine.io-client:websocket"),
      ...
      (function (e) {
        var n = r(6), o = r(4), i = r(2)("engine.io-client:socket"), s = r(8), a = r(1), u = r(7), c = r(3);
    ...
    (function (t) {
      var n = r(2), o = r(9), i = Object.prototype.toString,
    ...
    var n = r(22), o = r(4), i = r(8), s = r(0)("socket.io-client");
    t.exports = e = u;
    var a = e.managers = {};

    function u(t, e) {
      "object" == typeof t && (e = t, t = void 0), e = e || {};
      var r, o = n(t), u = o.source, c = o.id, f = o.path, h = a[c] && f in a[c].nsps;
